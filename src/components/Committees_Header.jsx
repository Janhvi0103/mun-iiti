...
export default function CommitteesHeader(){
    return (
        <>
            <div className="w-[100vw] overflow-x-hidden overflow-y-hidden relative h-[50vh]">
                <img src={headImg} alt="head" className="h-[100%] w-full bg-center brightness-50 object-cover " />
                <div className="absolute animate__animated animate__fadeInRight md:top-[11vh] top-[8vh] left-[5vh] lg:left-[25vh] w-[90%]">
