...
export default function Committees() {
  ...
  return (
    <>
      <NavBar />
      <div className="bg-gradient-to-b no-scrollbar from-slate-400 to-slate-300 overflow-x-hidden h-[145vh]">
        <div className="relative w-[80vw] h-[80vh] mx-auto flex justify-center items-center top-[30vh]">
          {/* Centered Title */}
          <h1 className="absolute text-3xl lg:text-5xl font-bold text-black">
            COMMITTEES
          </h1>
            ...
            return (
              <Dialog.Root key={ind}>
                <div
                  ...
                  style={{
                    transform: `rotate(${angle}deg) translate(0, -50vh) rotate(-${angle}deg)`, // increase translate for larger radius
                  }}
                >
